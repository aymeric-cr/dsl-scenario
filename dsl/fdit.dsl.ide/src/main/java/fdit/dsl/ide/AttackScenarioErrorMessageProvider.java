...
public class AttackScenarioErrorMessageProvider extends SyntaxErrorMessageProvider {
    ...
    private static final MessageTranslator TRANSLATOR = MessageTranslator.createMessageTranslator(AttackScenarioErrorMessageProvider.class);
    ...
    private SyntaxErrorMessage getMismatchedErrorMessage(final MismatchedTokenException mismatchedException,
        ...
        try {
            ...
            final Optional<TerminalRule> terminalRule = StreamUtils.tryFind(allTerminalRules(grammarAccess.getGrammar()),
