...
import fdit.ltlcondition.services.LTLConditionGrammarAccess
...
class LTLConditionErrorMessageProvider extends SyntaxErrorMessageProvider {

    static val MessageTranslator TRANSLATOR = createMessageTranslator(LTLConditionErrorMessageProvider)

    @Inject
    var LTLConditionGrammarAccess grammarAccess
